...
import LongRecipe from "./LongRecipe.js";
import "./App.css";
import {
...
function App() {
  console.log("App.defaultProps=" + App.defaultProps);
  return (
    <div className="machineContainer">
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
        <Link exact className="navbar-brand" to={`/recipes/`}>
          English Recipes
        </Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            <li className="nav-item active">
              <Link exact className="nav-link" to={`/recipes/`}>
                Home
              </Link>
            </li>

            {App.defaultProps.recipes.map((item) => {
              return (
                <li className="nav-item">
                  <Link
                    exact
                    className="nav-link my_nav"
      ...
      <Switch>
        <Route
          exact
          path="/recipes/:name"
          render={(routeProps) => <LongRecipe {...routeProps} />}
        />
        ...
        <Route
          ...
          path="/recipes"
          render={(routeProps) => (
            <RecipeHome stuff={App.defaultProps} {...routeProps} />
          )}
        />
...
App.defaultProps = {
  recipes: [
    ...
    },
    {
      ...
      imageURL:
        "https://storage-cube.quebecormedia.com/v1/dynamic_resize?quality=75&size=1500x1500&src=http%3A%2F%2Fstorage-cube.quebecormedia.com%2Fv1%2Fcl_prod%2Fcanadian_living%2Fec57f7d6-e56e-4b5e-9a51-fb1300b3e421%2Fblueberry-oatmeal-squares2501359401339.jpg",
      originalURL:
